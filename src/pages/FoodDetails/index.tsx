...
const FoodDetails: React.FC = () => {
  ...
  function handleDecrementExtra(id: number): void {
    ...
    if (!findExtra) return; // se não tiver extra
    if (findExtra.quantity === 0) return; // se for igual a zero, nao decrementa mais
  ...
  function handleIncrementFood(): void {
    setFoodQuantity(foodQuantity + 1); // adiciona 1 no estado
  }

  function handleDecrementFood(): void {
    if (foodQuantity === 0) return; // se for igual a zero, nao decrementa mais

    setFoodQuantity(q => (q !== 1 ? q - 1 : q));
  }
